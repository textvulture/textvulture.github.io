...
### - 'Othering' H: disease`r fa("virus", fill='red')` + stigmatized group `r fa("hand-pointer", fill='orange')` => blame `r fa("head-side-virus", fill="yellow")`! : only Asians

### - "behavioral immune system' H: .yelllow[all] minorities
]
