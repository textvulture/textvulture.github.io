...
---
class: inverse, center, middle
background-image: url(https://github.com/textvulture/textvulture.github.io/blob/master/images/holeBackground1.png?raw=true)
background-size: 100%
...
# Could be .bluey[no]: more connectivity, more disagreement

--

# What do .pink[data] `r fa('chart-column')` say?
...
background-image: url(https://media4.giphy.com/media/1xkMucz3jc5AGB4elL/200w.gif?cid=6c09b952xv5kvydxc1jr2yzy164o33h5ot5nmq9bs1l5wzof&ep=v1_gifs_search&rid=200w.gif&ct=g)
background-size: contain
...
# .large[.red[Only] Nuke Threats in E. Asia?]
...
# Because of effective .pink[social control]?
...
# `r fa('circle-exclamation', fill='red')` Maybe, .red[not] strong enough, tho.
...
# '.green[Exit Polls]' (Change et al. 2009): .pink[.Small["*Are conditions improving?* "]]
...
# '.green[Exit Polls]' (Change et al. 2009):

--

## - generally better informed than we thought.
...
# But what about the .red[current] regime?(since 2011)

.pull-left[

# What to do with the **elites**?
...
### Need to pay attention to the .Blue[entourage]
...
![](https://i.gifer.com/95nT.gif)

]

---

background-image: url(https://github.com/textvulture/textvulture.github.io/blob/master/images/Mahdavi2020.png?raw=true)
background-size: 45%
background-position: right

# .Large[**Case Study**:] <br>Elites and .pink[Kim Jung-un] <br>(Mahdavi & Ishiyama 2020)

--

## `r fa('newspaper', fill='purple')` elite .red[co-appearance] w/ Kim <br> (news data)

--

## - .orange[2012]: top 27% -> half of all ties

## - .green[2014]: top 13% -> half of all ties

--

## `r fa('skull', fill='blue')`  purges and concentrations
