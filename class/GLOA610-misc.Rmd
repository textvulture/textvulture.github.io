...
background-size: contain
background-image: url(https://c.tenor.com/inSUlloTGjgAAAAd/tenor.gif)
background-size: 100%

# .huge[**Is .red[De-growth] the Answer? **]
...
---
class: inverse, middle
background-image: url(https://media.cnn.com/api/v1/images/stellar/prod/230113124012-03-lutzerath-germany-coal-mine-climate-intl-restricted.jpg?c=original)
background-position: right
background-size: 100%
background-color: black
...
## `r fa('book', fill='red')` Savoia & Sen (2021)
