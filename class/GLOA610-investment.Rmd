...
.full-width-green[
# Overall Pattern of FDI (recipients)
]
...
.pull-left[
## .large[`r fa("crown", fill="orange")` Who are the hosts ?]

## .large[`r fa("clock", fill="red")` Does it change much?]

## .large[`r fa("circle-exclamation", fill="green")` Does it matter?]
]
...
.pull-right[
<iframe
  src="https://public.flourish.studio/visualisation/21271771/embed"
  width="100%"
  height="520"
  frameborder="0"
  scrolling="no"
