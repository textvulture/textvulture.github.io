...
<iframe src="https://textvulture.github.io/syllabi/GLOA610H.html" width="110%" height="525">
  </iframe>
...
# .Large[Go to Canvas & sign up for .pink[two] spots. <br> Spots need to be separated by at least .yellow[two] weeks.]
...
## .red[Not at all] asking you to write your case report exactly like this. 
...
2. .Large[Discovering .orange[Research Questions] (a simple question) `r fa("person-circle-question", fill='Purple')`] 
...
### variables: factors of interest whose values .orange[vary]
...
* Again, not asking you to write your case report just like this.