...
# library(magick)  
library(ggplot2)
knitr::opts_chunk$set(warning = FALSE, message = FALSE, error=FALSE, echo=F)
...
## - An identifiable .pink[event of economic distress] resulting from .orange[precipitously] and .green[dramatically] worsening macroeconomic conditions that authorities .blue[cannot readily improve].

]

--
### - Perennial problems aren't economic .red[crises].
...
# .pink[Consequences]: policy switches (Campello 2014)

--

## A difference crises can make:
