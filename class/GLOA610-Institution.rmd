...
### In contrast with .pink[STRUCTURE]

--
- .Large[given, not devised]
- .Large[uncontrollable]
- .Large[*geography; climate; populations*]
...
## Addresses one of the biggest fears: <br>.red[uncertainty] on .green[**property rights**]
...
### .red[Impersonal enforcement `r fa("gavel")`] <br>`r fa("arrow-right")` more transactions `r fa("arrow-right")` .bluey[development]
...
# .Large[In particular, we talk about:]
...
# .Huge[.pink[Where] does the difference come from?]
...
### - where do good institutions <br>come from?
