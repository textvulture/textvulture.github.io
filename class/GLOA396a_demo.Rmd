...
## Increasing accountability: .blue[vertical] and/or .red[horizontal]

```{r}


knitr::include_graphics('https://github.com/textvulture/textvulture.github.io/blob/master/images/backsliding_concept.jpg?raw=true')
...
## - movement from autocracy towards democracy
