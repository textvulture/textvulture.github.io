...
knitr::include_graphics("https://github.com/textvulture/textvulture.github.io/blob/master/images/UN.JPG?raw=true")
```
...
```{r, fig.align='center', out.width="700px"}
knitr::include_graphics("https://github.com/textvulture/textvulture.github.io/blob/master/images/UN1.JPG?raw=true")
```
...
```{r, fig.align='center', out.width="700px"}
knitr::include_graphics("https://github.com/textvulture/textvulture.github.io/blob/master/images/UN2.JPG?raw=true")
```
...
```{r, fig.align='center', out.width="700px"}
knitr::include_graphics("https://github.com/textvulture/textvulture.github.io/blob/master/images/UN3.JPG?raw=true")
```
...
```{r, fig.align='center', out.width="700px"}
knitr::include_graphics("https://github.com/textvulture/textvulture.github.io/blob/master/images/UN4.JPG?raw=true")
```
...
```{r, fig.align='center', out.width="700px"}
knitr::include_graphics("https://github.com/textvulture/textvulture.github.io/blob/master/images/UN5.JPG?raw=true")
```
...
.full-width-green[
# Some .yellow[barriers] might be just imagined .tiny[(signs of deglobalization?)]
]
