...
.center[.Large[.red["Don't trust that!"]]]
]
...
.full-width-green[
# To eliminate poverty, how much would it cost? .tiny[(Sahoo et al. 2025)]
]
<br> 
--

## - To reduce extreme poverty to ~1%:
--

-	.Large[≈ .red[$318] billion/year globally]
-	.Large[≈ 0.3% of global GDP (11% of a poor country's GDP), but only if .purple[every] poor person was identified)] 

--

## - So, international transfer? Foreign aid?; 'Wealth transfer'?

--

## - Targeted vs. Simple: effectiveness vs. efficiency  trade off
--

- .Large[targeting is cheaper (43%), but incurs admin costs]
- .Large[data transparency]
