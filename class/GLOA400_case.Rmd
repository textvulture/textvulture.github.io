...
# .times[.Large[.red[Case Studies], <br> & .Blue[Process Tracing]]]
...
# An .orange[example] of selection bias in case study: <br> Skocpol (1979) *State and Social Revolution*
...
### - methods
  ...
  - .large[variants of Mill's methods, but with .orange[sequence]]; often *descriptive* and *typological*
  
  - .large[.orange[process tracing]: a complete anatomy of the intervening process]
...
background-image: url(https://cdn.prod.website-files.com/65ff3881d9c8b3b51490c6bf/672d26e4ca1a95500cc6fe5e_6621f15a36e74384d85262ca_1*gGfAGnFP_T97o9tehx87PA.gif)
background-size: 120%
background-position:
background-color: black

# .Large[**Process Tracing**]
--

## - Great when the argument is of .yellow[multi-sequence].
...
### $$ \mathbf{X} \rightarrow A \rightarrow B \rightarrow C \rightarrow  \mathbf{Y}$$
