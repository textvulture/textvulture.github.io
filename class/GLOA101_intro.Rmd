...
# `r fa('hand-point-right', fill='green')` So has the 'end of history' emerged?
...
## If we did, then that's it. <br>*Globalization accomplished*.
...
class: inverse
background-image: url(https://media1.tenor.com/m/tHWzKQssV3AAAAAC/despicable-me3-despicable-me3gi-fs.gif)
background-size: 130%
...
# - All the backlash because people are angry<br>But angry about .yellow[WHAT]?
...
.large[### .black["the .green[expansion] and .orange[intensification] of social relations and consciousness across world-time and world-space, creating a planetary .pink[interconnectedness] where local events are shaped by distant happenings, and vice-versa."]]]
...
# GLOA 101 offers a .red[compromising] view. Others:
...
.full-width-green[
# But the deglobalizers (e.g., Poast 2022)
]
<br>
--

## `r fa("map-pin", fill='red')` Hallmark of 1990s-style globalization:
--

- .Large[expansion of open markets]
- .Large[integrated supply chains] 
- .Large[borderless economic interaction]

--

## `r fa("turn-down", fill='purple')`  Turning point: US-China trade war

--
- .Large[trade control]
- .Large['Weaponized Interdependence' (Farrel & Newman 2023)]

--

## `r fa("eye", fill='green')` Russian Invasion of Ukraine; Covid-19:  the '.red[exposers]'