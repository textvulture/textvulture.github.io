...
## 2. What was the key to some of the successes?
  .Large[2-1. And are they a panacea?]
...
# .huge[Asia, where theories do .red[not] work (yet again).]

--

# .yellow[`r fa("glasses")`] Let's see if existing theories (speculations) on development of Asia work.

--

# .yellow[`r fa("glasses")`] In particular, we will compare .red[Asia] with .blue[Latin America].
...
### - byproduct: unwanted .red[legacy] of developmental state

---

.Large[**The legacy: .red[unwavering] authoritarian loyalty** (Hong et al. 2022)]

--

.pull-left[

![](https://github.com/textvulture/textvulture.github.io/blob/master/images/Hong2022_2.JPG?raw=true)
...
![](https://github.com/textvulture/textvulture.github.io/blob/master/images/Hong2022_3.JPG?raw=true)
...
## Or at least, will it be a .red[hard] currency `r fa("money-bill", fill='green')` in the near future?
