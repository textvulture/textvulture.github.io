...
It will be a water-shedding moment for the United States and the rest of the world for the foreseeable future, for better or worse. I need to have a clear picture of what went down, an anchor to which I can keep 'updating my priors' over time (during which *a lot* will happen). This post serves that purpose, and that purpose only. My mental health can take a back seat for that.
