...
# .huge[**Is .red[Degrowth] the Answer? <br> (McAfee 2020)**]
...
### - Shapiro (2020)
  ...
  - .large[is global trade anti-environment?]
...
# .green[**And it ain't all outsourcing**]
...
```{r, out.width="850px", fig.align='center', cache=T}
...
background-image: url(https://github.com/textvulture/textvulture.github.io/blob/master/images/Sigman2022_2.png?raw=true)
background-position: right
background-size: 35%
...
--
  ...
  - .Large[oil-curse or "disgruntled employees" `r fa("face-angry", fill='green')` ?] <br>
  
```{r, out.width="600px"}
  
  knitr::include_graphics("https://github.com/textvulture/textvulture.github.io/blob/master/images/Sigman2022_3.png?raw=true")
