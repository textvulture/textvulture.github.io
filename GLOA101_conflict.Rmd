...
---
# **Human Security**: Freedom from .red[Political Killing] and .blue[Torture]
...
# **Human Security**: Life expectancy at birth (World Bank)

```{r, echo=FALSE, fig.height=7, fig.width=13, message=FALSE, warning=FALSE, cache=TRUE}

wdi %>%
  ggplot(aes(x = year, y=life, alpha=0.1)) +
  geom_point(size=1) + 
  geom_smooth() +
  theme_minimal() + 
  theme(
