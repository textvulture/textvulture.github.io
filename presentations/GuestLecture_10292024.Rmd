...
## But This won't be a research presentation.
  ...
  - .Large[I mean, you've already read the paper `r fa('paperclip', fill='orange')` .]
...
--
  ...
  - .Large[If you're interested in how this project was .pink[presented] in a conference, here's the link to the slides: (Presented at MPSA 2021)]
...
## The theoretical background: .orange[democratic backsliding] in South Korea, .small[compromised .green[Freedom of Speech], in particular (V-dem)]
