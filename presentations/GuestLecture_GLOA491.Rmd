...
### .right[GLOA 396 (MK) Guest Lecture]
...
# Now let's get on to the .bluey[project].
...
# .HUGE[.yellow[**The Subject**]]

--

## .Green[The thing that you just come across.]
...
# `r fa("book", fill='orange')` Blacklists
...
# **Motivation** .pink[.small[.tiny[(& why I chose the particular method)]]]

--

- .Large[This is upsetting `r fa('face-angry', fill='red')`.]

--

  - .Large[But .pink[what] exactly am I upset about?]
  
--

  - .Large[Suppression of freedom of speech?<br>**Yes,** but more.]

--

  - .Large[*sleazy people ruining<br> cool people's lives.* `r fa('face-tired', fill='orange')`]
      
--

  - .Large[I need to show this was real bad<br> on people's lives. But .red[how?]]

--

  - .Large[Interviews? Fieldwork?]
    
--
  
- .Large[**Only** if the victims were aware of things.]
...
```{r, echo=F}
df <- readRDS('/Users/bson3/GitHub/archive/bkv_democratization_2024/data.rds')
```
