...
# what .red[scares] you the most `r fa("face-grimace")`?
...
# .Large[.yellow[So this week, we need to go back-and-forth over the .red[history.]]]

--

# .Yellow[The origins of institutional strength often go] .yellow[way back].
...
## - an application: which institution is .red[better]?
...
# `r fa("landmark")` &nbsp; Institutions `r fa("arrow-right")` development 
...
# `r fa("landmark")` Sometimes a bad name

## institutional '.red[quality]' 
...
# Some data for example: .red[institutions] and .green[development]
...
class: inverse
background-color: black
background-image: url("https://www.nps.gov/articles/images/Middle-Passage-Map-Final-reduced-size.jpg")
background-size: contain
background-position: right

# .Large[Why were .yellow[some] <br> European countries <br> richer than others?]
...
# .Large[Which institution is <br> better for development, <br> .orange[**democracy**] or .bluey[**autocracy**]?]
