...
# what .purple[scares] you the most `r fa("face-grimace")`?
...
# .Large[Is there a way to put this .yellow[anxiety] to bed?]
...
## - increases credibility `r fa("arrow-right")` predictability
...
# Empirical example: .red[institutions] and .green[development] 
- .large[.orange[pooled] global sample]
