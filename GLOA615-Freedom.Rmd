...
background-image: url('http://textvulture.github.io/images/fh-img2.png')
background-size: contain
...
## .red[`r fa("smile-wink")`] traditional tactic: 'tolerance' [elite cohesion + counter-protest + court]
---
...
### .Large[ `r fa("th-large")`: the .green[types] of posts focused on]
...
# `r fa("question-circle", fill="green")` But wouldn't the censorship too obvious?
