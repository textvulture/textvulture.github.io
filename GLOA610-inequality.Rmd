...
# But wouldn't <br> globalization <br> .red[exacerbate] inequality?

--

# Sometimes. .red[Not] in the way <br> you think it does, though.
...
background-image: url(Banerjee2015.png)
background-position: right
background-size: contain
